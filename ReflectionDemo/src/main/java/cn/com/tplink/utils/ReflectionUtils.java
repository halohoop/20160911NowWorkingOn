 ...
 * Author huanghaiqi
 *
 * Ver 1.0, 2016-09-07, huanghaiqi, Create file
 */

package cn.com.tplink.utils;
...
public abstract class ReflectionUtils {
    ...
    public Object getFieldValue(Object paramObject, String paramString) {
        ...
        try {
            Field localField = localClass.getField(paramString);
    ...
    public static Object getStaticFieldValue(String paramString1,
                                             String paramString2) {
        try {
    ...
    public Object getPrivateFieldValue(Object paramObject, String paramString) {
        try {
            Class<?> localClass = paramObject.getClass();
    ...
    public static Method getMethod(String paramString1, String paramString2,
        ...
        try {
            Class<?> localClass = Class.forName(paramString1);
            return localClass.getMethod(paramString2, paramArrayOfClass);
        } catch (Exception localException) {
            // a.error("Get method error. " + localException.getMessage());
        }
        return null;
    }
    ...
    public static Object invokeMethod(Object paramObject, String paramString,
        ...
        Class<? extends Object> localClass = paramObject.getClass();
        Object localObject = null;
        try {
            ...
            // a.error("Invoke method error. " + localException.getMessage());
        }
        return localObject;
    }
    ...
    public static Object invokeMethod(Object paramObject, String paramString,
        ...
        Object localObject = null;
        try {
            Method localMethod = localClass.getMethod(paramString,
                    paramArrayOfClass);
            localObject = localMethod.invoke(paramObject, paramArrayOfObject);
        } catch (Exception localException) {
            // a.error("Invoke method error. " + localException.getMessage());
    ...
    public static Object invokeMethod(Class<?> paramClass, String paramString,
                                      Object... paramArrayOfObject) {
        try {
            Object localObject = paramClass.newInstance();
            return invokeMethod(localObject, paramString, paramArrayOfObject);
        } catch (Exception localException) {
            // a.error("Invoke method error. " + localException.getMessage());
        }
        return null;
    ...
    public static Object invokeMethod(String paramString1, String paramString2,
        ...
        try {
            Class<?> localClass = Class.forName(paramString1);
            return invokeMethod(localClass.newInstance(), paramString2,
                    paramArrayOfObject);
        } catch (Exception localException) {
            // a.error("Invoke method error. " + localException.getMessage());
        }
    ...
    public static Object invokeStaticMethod(Class<?> paramClass,
    ...
    public static Object invokeStaticMethod(String paramString1,
        ...
        try {
            Class<?> localClass = Class.forName(paramString1);
            return invokeStaticMethod(localClass, paramString2,
                    paramArrayOfObject);
        } catch (Exception localException) {
            // a.error("Invoke method error. " + localException.getMessage());
        }

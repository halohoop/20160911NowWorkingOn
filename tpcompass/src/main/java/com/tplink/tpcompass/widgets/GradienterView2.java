...
public class GradienterView2 extends View {
    ...
    public GradienterView2(Context context) {
        this(context, null);
    }

    public GradienterView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GradienterView2(Context context, AttributeSet attrs, int defStyleAttr) {
